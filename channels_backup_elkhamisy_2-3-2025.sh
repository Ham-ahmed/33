...
wget -O /var/volatile/tmp/$channel-$"version".tar.gz "https://raw.githubusercontent.com/Ham-ahmed/33/refs/heads/main/channels_backup_2-3-2025-AJPANEL-elkhamisy.tar.gz"
